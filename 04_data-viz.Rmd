...
We will now create and discuss data visualizations based on ggplot2 and the grammar of graphics. This chapter relies heavily on the [ggplot2 Cheat Sheet](https://rstudio.github.io/cheatsheets/html/data-visualization.html?_gl=1*10368jz*_ga*MjQ1OTc2NzA0LjE3MTIxMzM1NTU.*_ga_2C0WZ1JHG0*MTcxMzUyMzU4My40LjEuMTcxMzUyMzYxNS4wLjAuMA..). To learn more, also consult the [ggplot2 website](https://ggplot2.tidyverse.org/) and [this chapter](https://r4ds.had.co.nz/data-visualisation.html) from Wickham and Grolemund's _R for Data Science_.
...
Modify the _statistical transformation_ of the data before plotting: pick a different width for the histogram bins.
